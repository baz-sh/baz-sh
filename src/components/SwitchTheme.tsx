...
export default function SwitchTheme() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed z-50 top-0 mt-5 mr-5 right-0 p-2 rounded-full bg-muted-foreground/40 hover:bg-muted-foreground/60 text-headings transition-colors cursor-pointer"
