...
once you've navigated to that directory with the tool installed, you can simply type
`j SomeProject` and it will jump to that directory, no matter where you are!
That's pretty neat if you have to keep navigating various directories and the time
saved is definitely starting to add up!
