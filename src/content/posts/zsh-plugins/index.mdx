...
I was going to wrap things up there but I've recently started using autojump
and things it's definitely worth mentioning. [AutoJump](https://github.com/wting/autojump)
learns as you navigate your system. So rather than constantly running something like
...
we've navigated to that directory, we can run `j AnotherProject` and it will jump
to that directory, no matter where we are in the filesystem! That's pretty neat
if you have to keep navigating various directories and the time saved is definitely
starting to add up!
