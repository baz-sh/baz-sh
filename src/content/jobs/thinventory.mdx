...
- Go out in the field to understand how the app is used in real-world scenarios, ensuring that the
app meets the needs of the users.
- Iterative / lean development approach, focusing on delivering value quickly and efficiently.

Tools used: React, Xamarin, C#, TypeScript, Android, iOS
